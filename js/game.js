...
var game = function(){
        ...
        var intro2 = function(instruct,pressnext){
                ...
                box.x=50;
                box.y = 320;
                instruct.on("click",function(){intro3(instruct)});
        
        
        }
        var intro3 = function(instruct){
                
                var instructions = new createjs.Text("And here is our special equipment!", "20px Arial","black");
                instructions.x = 300;
                instructions.y = 450;
                stage.addChild(instructions);
                t1.y = 490;
